<?php if ( get_theme_mod( 'product-content' ) == "Display" ) { ?>
	<div class="productshowcase">
		<?php $customcolors = get_theme_mod( 'product-colors' );
		if ($customcolors == "on") {
		...
		<div class="widgetwrap">
			<div class="titlewrap610"><h2><?php echo get_theme_mod( 'product-title' ); ?></h2>
			</div>
								...
								<li>
									<div class="sportsscore" style="width:160px">
										...
										<?php if ( has_post_thumbnail() ) {
											the_post_thumbnail( 'homefeature',
											                    array( 'class' => 'featureimage' ) );
										} ?>
										<?php $link =
											get_post_meta( $post->ID, 'customlink', TRUE );
										$click      =
											get_post_meta( $post->ID, 'click_tracker_code',
											               TRUE ); ?>
										<p class="homeheadline"><?php if ( $link ) {
										...
										<div class="productteaser">
											<p><?php the_content_limit( 50, '' ); ?></p></div>
