...
<head profile="http://gmpg.org/xfn/11">
	...
	<script src="<?php echo get_template_directory_uri(); ?>/javascript/jquery-latest.pack.js" type="text/javascript"></script>
	...
	<script src="<?php echo get_template_directory_uri(); ?>/javascript/jcarousellite_1.0.1c4.js" type="text/javascript"></script>
	<script type="text/javascript">
		$(function () {
	...
	<?php include( get_template_directory() . "/customstyles.php" ); ?>
...
<body>
	...
	<div id='div-gpt-ad-1392153511566-0' style='width:1px; height:1px;'>
		<script type='text/javascript'>
			googletag.cmd.push(function () {
				googletag.display('div-gpt-ad-1392153511566-0');
			});
		</script>
	</div>
	...
	<div id='div-gpt-ad-1392153511566-0-oop'>
		<script type='text/javascript'>
			googletag.cmd.push(function () {
				googletag.display('div-gpt-ad-1392153511566-0-oop');
			});
		</script>
	</div>
	...
	<?php
	if ( get_theme_mod( 'leaderboard-location' ) == "Above Header" ) {
		include( get_template_directory() . "/leaderboardhead.php" );
	}
	if ( get_theme_mod( 'breakingnews-location' ) == "Header" ) {
		...
		if ( $bncheck == "bsno837625b" ) {
			include( get_template_directory() . "/tools/breakingnews.php" );
		}
	}
	?>
			...
			<div id="headerleft" <?php if (get_theme_mod( 'header_blog_title' ) == 'Image') { ?>style="padding-left:0;width:960px;" <?php } ?>>
				...
				<?php if ( get_theme_mod( 'header_blog_title' ) == 'Image' ) { ?>
					...
					<a href="<?php echo get_option('home'); ?>/"><img
							src="<?php echo get_theme_mod( 'header-image' ); ?>"
			...
			<div id="navbarright">
				...
				<form id="searchform" method="get" action="<?php echo $_SERVER['PHP_SELF']; ?>">
					<input type="text" value="search our site..." name="s" id="searchbox"
					       ...
					       onblur="if (this.value == '') {this.value = 'search our site...';}"/><input
						type="image" style="vertical-align:top;"
						src="<?php echo get_template_directory_uri(); ?>/images/search.png" alt="Search"/>
				</form>
		...
		<?php if ( get_theme_mod( 'bottomnav' ) == "Show" ) { ?>
			...
			<div id="subnavbar">
				...
				<div class="subnavbarright">
					<p><a href="<?php bloginfo( 'rss_url' ); ?>"><img style="vertical-align:middle;"
					                                                  src="<?php echo get_template_directory_uri(); ?>/images/rss.gif"
					                                                  alt="Subscribe to <?php bloginfo( 'name' ); ?>"/></a><a
							href="<?php bloginfo( 'rss_url' ); ?>"></a></p>
				</div>
			</div>

		<?php }

		if ( get_theme_mod( 'leaderboard-location' ) == "Below Header" ) {
			include( get_template_directory() . "/leaderboardhead.php" );
		}
		?>
